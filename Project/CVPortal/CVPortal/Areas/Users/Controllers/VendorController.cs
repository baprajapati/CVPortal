...
namespace CVPortal.Areas.Users.Controllers
{
    public class VendorController : Controller
    {
        ...
        public JsonResult EnableVendor(int id)
        {
            try
            {
        ...
        public ActionResult GetVendor(VendorListModel model)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    vendorIds.AddRange(dataContext.VendorApprovals.Where(x => !x.IsDeleted && x.CreatedById == Utility.UserId).Select(x => x.VendorId).ToList());
                }
